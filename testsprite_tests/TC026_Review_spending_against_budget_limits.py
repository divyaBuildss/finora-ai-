...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email field with testsprite@finora-test.com, fill the password with TestSprite@2026, then submit the login form by clicking the submit button.
        ...
        # -> Click the 'Budgeting' navigation link (interactive element index 463) to open the budget planner so its category progress bars can be verified.
