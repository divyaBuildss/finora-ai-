...
async def run_test():
    ...
    try:
        ...
        # -> Fill email (element 249) and password (element 250), then click the submit button (element 253) to attempt sign-in.
        ...
        # -> Type a finance question into the advisor input (index 830) and send it (press Enter) to trigger a response.
        ...
        await elem.wait_for(state="visible", timeout=10000)
        await elem.fill("How can I save \u20b910,000 in 3 months?")
